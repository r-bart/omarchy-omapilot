...
required=(
  ...
  skills/omarchy-omapilot/SKILL.md
  skills/omarchy-omapilot/agents/openai.yaml
...
mkdir -p "$stage/runtime/dist/adapters" "$stage/runtime/bin" "$stage/skills/omarchy-omapilot/agents"
...
cp "$repo_root/skills/omarchy-omapilot/SKILL.md" "$stage/skills/omarchy-omapilot/"
cp "$repo_root/skills/omarchy-omapilot/agents/openai.yaml" "$stage/skills/omarchy-omapilot/agents/"
