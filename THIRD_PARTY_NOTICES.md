...
The exact transitive dependency graph and declared licenses for each runtime archive are recorded in its generated CycloneDX `sbom.cdx.json`. Adapter bundle legal notices are shipped beside the bundles. This notice is attribution, not a replacement for those license texts.
